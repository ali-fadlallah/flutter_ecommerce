...
import '../../features/cart/domain/repositories_contract/cart_repo_datasource.dart'
    as _i14;
import '../../features/cart/domain/use_cases/Add_to_cart_UseCase.dart' as _i48;
...
import '../../features/cart/presentation/manager/cart_cubit.dart' as _i50;
...
import '../../features/home/presentation/manager/home_tab_view_model.dart'
    as _i25;
import '../../features/home/presentation/manager/home_viewmodel.dart' as _i55;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i20.ClearCartUseCase>(
        () => _i20.ClearCartUseCase(gh<_i14.CartRepoDataSource>()));
    gh.factory<_i21.DeleteCartUseCase>(
        () => _i21.DeleteCartUseCase(gh<_i14.CartRepoDataSource>()));
    gh.factory<_i22.GetBrandsUseCase>(
        () => _i22.GetBrandsUseCase(gh<_i10.BrandsRepo>()));
    gh.factory<_i23.GetCartUseCase>(
        () => _i23.GetCartUseCase(gh<_i14.CartRepoDataSource>()));
    gh.factory<_i24.GetCategoryUseCase>(
        () => _i24.GetCategoryUseCase(gh<_i18.CategoryRepository>()));
    gh.factory<_i25.HomeTabViewModel>(() => _i25.HomeTabViewModel());
    gh.factory<_i26.ProductDataSource>(
        () => _i27.ProductDataSourceImpl(gh<_i3.ApiManager>()));
    gh.factory<_i28.ProductsRepo>(
        () => _i29.ProductRepoImpl(gh<_i26.ProductDataSource>()));
    gh.factory<_i30.ProfileDataSource>(
        () => _i31.ProfileDataSourceImpl(gh<_i3.ApiManager>()));
    gh.factory<_i32.ProfileRepo>(
        () => _i33.ProfileRepoImpl(gh<_i30.ProfileDataSource>()));
    gh.factory<_i34.SignInAuthUseCase>(
        () => _i34.SignInAuthUseCase(gh<_i6.AuthRepo>()));
    gh.factory<_i35.SignInViewModelCubit>(
        () => _i35.SignInViewModelCubit(gh<_i34.SignInAuthUseCase>()));
    gh.factory<_i36.SignUpAuthUseCase>(
        () => _i36.SignUpAuthUseCase(gh<_i6.AuthRepo>()));
    gh.factory<_i37.SignupViewModelCubit>(
        () => _i37.SignupViewModelCubit(gh<_i36.SignUpAuthUseCase>()));
    gh.factory<_i38.SubCategoryDataSource>(
        () => _i39.SubCategoryDataSourceImpl(gh<_i3.ApiManager>()));
    gh.factory<_i40.SubCategoryRepository>(
        () => _i41.SubCategoryRepoImpl(gh<_i38.SubCategoryDataSource>()));
    gh.factory<_i42.UpdateCartUseCase>(
        () => _i42.UpdateCartUseCase(gh<_i14.CartRepoDataSource>()));
    gh.factory<_i43.UpdateProfileDataUseCase>(
        () => _i43.UpdateProfileDataUseCase(gh<_i32.ProfileRepo>()));
    gh.factory<_i44.WishListDataSource>(
        () => _i45.WishListDataSourceImpl(gh<_i3.ApiManager>()));
    gh.factory<_i46.WishListRepo>(
        () => _i47.WishListRepoImpl(gh<_i44.WishListDataSource>()));
    gh.factory<_i48.AddToCartUseCase>(
        () => _i48.AddToCartUseCase(gh<_i14.CartRepoDataSource>()));
    gh.factory<_i49.AddToWishListUseCase>(
        () => _i49.AddToWishListUseCase(gh<_i46.WishListRepo>()));
    ...
    gh.factory<_i51.GetMostSellingProductsUseCase>(
        () => _i51.GetMostSellingProductsUseCase(gh<_i28.ProductsRepo>()));
    gh.factory<_i52.GetProfileDataUseCase>(
        () => _i52.GetProfileDataUseCase(gh<_i32.ProfileRepo>()));
    gh.factory<_i53.GetSubCategoryUseCase>(
        () => _i53.GetSubCategoryUseCase(gh<_i40.SubCategoryRepository>()));
    gh.factory<_i54.GetWishListUseCase>(
        () => _i54.GetWishListUseCase(gh<_i46.WishListRepo>()));
    gh.factory<_i55.HomeViewModel>(() => _i55.HomeViewModel(
          gh<_i24.GetCategoryUseCase>(),
          gh<_i22.GetBrandsUseCase>(),
          gh<_i51.GetMostSellingProductsUseCase>(),
          gh<_i48.AddToCartUseCase>(),
          gh<_i23.GetCartUseCase>(),
        ));
    gh.factory<_i56.ProfileViewModelCubit>(() => _i56.ProfileViewModelCubit(
          gh<_i52.GetProfileDataUseCase>(),
          gh<_i43.UpdateProfileDataUseCase>(),
        ));
    gh.factory<_i57.WishListCubit>(() => _i57.WishListCubit(
          gh<_i49.AddToWishListUseCase>(),
          gh<_i54.GetWishListUseCase>(),
        ));
    gh.factory<_i58.CategoriesTabViewModelCubit>(
        () => _i58.CategoriesTabViewModelCubit(
              gh<_i24.GetCategoryUseCase>(),
              gh<_i53.GetSubCategoryUseCase>(),
            ));
    return this;
  }
}
